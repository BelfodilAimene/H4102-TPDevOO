...
public class Zone {
	 ...
	 *            nom du fichier XML de la zone
	 * @param noeuds
	 *            Dictionnaire des noeuds (par identifiant)
	 */
	 ...
	 * 
	 * @param noeud
	 *            noeud a ajouter dans le dictionnaire
	 */
	 ...
	 * 
	 * @param noeuds
	 *            liste des noeuds a ajouter dans le dictionnaire
	 */
	...
	/**
	 * 
	 * @return l'abscisse minimal du réseau
	 */
	public int getMinX() {
		int MinX = Integer.MAX_VALUE;
		for (Entry<Integer, Noeud> entry : noeuds.entrySet()) {
			if (MinX > entry.getValue().getX())
				MinX = entry.getValue().getX();
		}
		return MinX;
	}
	...
	/**
	 * 
	 * @return l'abscisse maximal du réseau
	 */
	public int getMaxX() {
		int MaxX = 0;
		for (Entry<Integer, Noeud> entry : noeuds.entrySet()) {
			if (MaxX < entry.getValue().getX())
				MaxX = entry.getValue().getX();
		}
		return MaxX;
	}
	...
	/**
	 * 
	 * @return l'ordonnée minimale du réseau
	 */
	public int getMinY() {
		int MinY = Integer.MAX_VALUE;
		for (Entry<Integer, Noeud> entry : noeuds.entrySet()) {
			if (MinY > entry.getValue().getY())
				MinY = entry.getValue().getY();
		}
		return MinY;
	}
	...
	/**
	 * 
	 * @return l'ordonnée maximale du réseau
	 */
	public int getMaxY() {
		int MaxY = 0;
		for (Entry<Integer, Noeud> entry : noeuds.entrySet()) {
			if (MaxY < entry.getValue().getY())
