...
/**
 * Classe représentant un chemin : liste de tronçons reliant deux noeuds
 * 
 * @author H4102
 *
 */
public class Chemin {
	...
	/**
	 * le cout du chemin (durée nécessaire pour parcourir le chemin en seconde)
	 */
	private double cout;

	/**
	 * la liste des tronçons composant le chemin
	 */
	private ArrayList<Troncon> listeTroncons;

	/**
	 * Construit un chemin avec le noeud de depart, d'arrivé et le cout en temps
	 * (en seconde), la liste des tronçon est initialement vide (finalisée par
	 * Djikstra)
	 * 
	 * @param depart
	 ...
	 *            noeud destination du chemin
	 * @param cout
	 *            durée nécessaire pour parcourir le chemin (en seconde)
	 */
	...
	/**
	 * 
	 * @return le cout du chemin (durée nécessaire pour parcourir le chemin en
	 *         seconde)
	 */
	...
	/**
	 * 
	 * @return la liste des tronçons composant le chemin
	 */
