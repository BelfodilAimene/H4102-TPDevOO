...
/**
 * classe représentant le graph de livraisons qui sera utilisé par TSP.
...
public class GraphLivraison implements Graph {
	 ...
	 * noeuds (livraisons/entrepôt). <b>matrice[i][j]</b> représente le
	 * chemin entre le noeud d'ordre i et le noeud d'ordre j (la correspondance
	 * entre noeud et ordre est faite via la table de correspondance). 
	 ...
	 * horaire de la livraison correspondant au noeud d'ordre j, ou à la plage
	 * qui le prècède directement. <b>Remarque 2: </b> le noeud d'ordre 0
	 * correspond à l'entrepôt. <b>Remarque 3: </b> le noeud d'ordre 0 est
	 * reliée à tout les noeuds coressponants a des livraisons appartenant à la
	 * prmière plage horaire. Les noeuds de la dernière plage horaire sont
	 * reliée au noeud d'ordre 0
	 */
	 ...
	 * 
	 * @param noeud noeud
	 * @return l'identifaint du noeud dans la matrice des chemins en utilisant
	 *         la table de correspondance . Retourne -1 dans le cas où le noeud
	 *         n'appartient pas à la table de correspondance
	 */
	...
	/**
	 * construit le graph de livraison et initialise la table de correspondance
	 * (sans initialiser la matrice des chemins)
	 * 
	 * @param feuilleDeRoute
	 *            la feuille de route associée au graph
	 */
	...
	/**
	 * initialise la matrice des chemins
	 * 
	 * 
	 */
