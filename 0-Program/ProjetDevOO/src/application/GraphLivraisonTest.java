...
public class GraphLivraisonTest {
	...
	public void testInitMatriceChemin() {
		...
		assertTrue(graphLivraison.getMatriceChemin()[0][0]==null);
		...
		assertTrue(graphLivraison.getMatriceChemin()[1][0]==null);
		assertTrue(graphLivraison.getMatriceChemin()[1][1]==null);
		assertTrue(graphLivraison.getMatriceChemin()[1][2]!=null);
		assertTrue(graphLivraison.getMatriceChemin()[1][3]!=null);
		
		assertTrue(graphLivraison.getMatriceChemin()[2][0]==null);
		assertTrue(graphLivraison.getMatriceChemin()[2][1]!=null);
		assertTrue(graphLivraison.getMatriceChemin()[2][2]==null);
		assertTrue(graphLivraison.getMatriceChemin()[2][3]!=null);
		
		assertTrue(graphLivraison.getMatriceChemin()[3][0]!=null);
		assertTrue(graphLivraison.getMatriceChemin()[3][1]==null);
		assertTrue(graphLivraison.getMatriceChemin()[3][2]==null);
		assertTrue(graphLivraison.getMatriceChemin()[3][3]==null);
	}

	@Test
	public void testGetNbSucc() {
		assertTrue(graphLivraison.getNbSucc(3)==1);
	}
